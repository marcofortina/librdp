...
if(DEFINED LIBRDP_OPENSSL_ROOT_DIR AND NOT "${LIBRDP_OPENSSL_ROOT_DIR}" STREQUAL "")
    list(APPEND configure_args -DOPENSSL_ROOT_DIR=${LIBRDP_OPENSSL_ROOT_DIR})
endif()
...
foreach(line IN LISTS symbol_lines)
    ...
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "SunOS" AND
       symbol MATCHES "^(_DYNAMIC|_etext|_GLOBAL_OFFSET_TABLE_|_PROCEDURE_LINKAGE_TABLE_)$")
        continue()
    endif()
