...
enum test_viewer_pointer_stage
{
    ...
    TEST_VIEWER_POINTER_MOUSE_READY = 12,
    TEST_VIEWER_POINTER_MOUSE_COMPLETE = 13,
    TEST_VIEWER_POINTER_KEYBOARD_READY = 14,
    TEST_VIEWER_POINTER_KEYBOARD_COMPLETE = 15,
    TEST_VIEWER_POINTER_FOCUS_READY = 16,
    TEST_VIEWER_POINTER_FOCUS_RELEASED = 17,
    TEST_VIEWER_POINTER_FOCUS_COMPLETE = 18,
    TEST_VIEWER_POINTER_ALT_TAB_READY = 19,
    TEST_VIEWER_POINTER_ALT_TAB_COMPLETE = 20,
    TEST_VIEWER_POINTER_COMPLETE = 21
};
...
enum
{
    ...
    TEST_VIEWER_POINTER_MOUSE_X = 91,
    TEST_VIEWER_POINTER_MOUSE_Y = 97
};
