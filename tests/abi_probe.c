...
int main(void)
{
    ...
    ABI_TYPE_ENTRY("librdp_server_pointer_update_type", librdp_server_pointer_update_type, ",");
    ABI_TYPE_ENTRY("librdp_server_pointer_update", librdp_server_pointer_update, ",");
    ...
    ABI_TYPE_ENTRY("librdp_server_event", librdp_server_event, ",");
    ABI_TYPE_ENTRY("librdp_server_credentials_request", librdp_server_credentials_request, ",");
    ABI_TYPE_ENTRY("librdp_server_status", librdp_server_status, ",");
