...
static int test_path_security_license_channels(void)
{
    ...
    }
    {
        ...
        PCHECK(dst_u[16u + 2u] == aux_u[0] && dst_v[16u + 2u] == aux_u[4]);
        PCHECK(dst_u[16u + 4u] == aux_v[0] && dst_v[16u + 4u] == aux_v[4]);
        PCHECK(dst_u[16u + 6u] == aux_u[1] && dst_v[16u + 6u] == aux_u[5]);
    ...
    }
    {
        ...
        chroma_view.dst_height = 5;
        PCHECK(rdp_avc_reconstruct_444v2_chroma(&chroma_view) == LIBRDP_STATUS_OK);
        PCHECK(dst_u[2] == aux_y[0] && dst_v[2] == aux_y[8]);
        PCHECK(dst_u[4] == aux_y[1] && dst_v[4] == aux_y[9]);
        PCHECK(dst_u[15u + 1u] == aux_u[0] && dst_v[15u + 1u] == aux_u[4]);
        PCHECK(dst_u[15u + 3u] == aux_v[0] && dst_v[15u + 3u] == aux_v[4]);
        PCHECK(dst_u[15u + 5u] == aux_u[1] && dst_v[15u + 5u] == aux_u[5]);
    }
