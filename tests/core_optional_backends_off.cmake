...
set(optional_off_binary_dir "${LIBRDP_BINARY_DIR}/core-optional-backends-off")
...
if(NOT configure_result EQUAL 0)
    message(FATAL_ERROR "optional backend OFF configure failed with ${configure_result}")
endif()
...
if(NOT build_result EQUAL 0)
    message(FATAL_ERROR "optional backend OFF build failed with ${build_result}")
endif()
