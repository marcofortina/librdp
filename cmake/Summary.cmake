...
if(LIBRDP_BUILD_MACOS_VIEWER)
    if(APPLE)
        librdp_summary_line(macos-viewer ON found librdp-macos-viewer yes enabled)
    else()
        librdp_summary_line(macos-viewer ON missing librdp-macos-viewer no platform-not-apple)
    endif()
else()
    librdp_summary_line(macos-viewer OFF not-searched librdp-macos-viewer no disabled-by-user)
endif()
