 ...
 */
/*
 * Module: fuzz target for clipboard virtual-channel parser, file-transfer, and
 * writer paths.
...
/*
 * Fuzz target: exercises clipboard virtual-channel parser, file-transfer, and
 * writer paths with one arbitrary input buffer.
