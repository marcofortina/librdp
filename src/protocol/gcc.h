 ...
 */
/*
 * Module: GCC conference data declaration contract.
...
#define RDP_GCC_SERVER_EARLY_EDGE_ACTIONS_V1 0x00000001u
#define RDP_GCC_SERVER_EARLY_DYNAMIC_DST 0x00000002u
#define RDP_GCC_SERVER_EARLY_EDGE_ACTIONS_V2 0x00000004u
#define RDP_GCC_SERVER_EARLY_SKIP_CHANNEL_JOIN 0x00000008u
#define RDP_GCC_SERVER_EARLY_KNOWN_FLAGS 0x0000000fu
