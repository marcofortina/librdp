 ...
 */
/*
 * Module: filesystem redirection metadata and packet declarations.
...
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_FILE_NAME 0x00000001u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_DIR_NAME 0x00000002u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_ATTRIBUTES 0x00000004u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_SIZE 0x00000008u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_LAST_WRITE 0x00000010u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_LAST_ACCESS 0x00000020u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CREATION 0x00000040u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_EA 0x00000080u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_SECURITY 0x00000100u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_STREAM_NAME 0x00000200u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_STREAM_SIZE 0x00000400u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_STREAM_WRITE 0x00000800u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_VALID_MASK 0x00000fffu
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_FILE_NAME 0x00000001u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_DIRECTORY_NAME 0x00000002u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_ATTRIBUTES 0x00000004u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_SIZE 0x00000008u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_LAST_WRITE 0x00000010u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_LAST_ACCESS 0x00000020u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_CREATION 0x00000040u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_CHANGE_SECURITY 0x00000100u

#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_ACTION_ADDED 1u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_ACTION_REMOVED 2u
#define RDP_FILESYSTEM_REDIRECTION_NOTIFY_ACTION_MODIFIED 3u
...
#define RDP_FILESYSTEM_REDIRECTION_SACL_SECURITY_INFORMATION 0x00000008u
#define RDP_FILESYSTEM_REDIRECTION_SUPPORTED_SECURITY_INFORMATION                                   \
    (RDP_FILESYSTEM_REDIRECTION_OWNER_SECURITY_INFORMATION |                                        \
     ...
     RDP_FILESYSTEM_REDIRECTION_SACL_SECURITY_INFORMATION)
