 ...
 */
/*
 * Module: USB redirection descriptor and transfer declarations.
...
#define RDP_USB_REDIRECTION_CHANNEL_NAME "urbdrc"
...
#define RDP_USB_REDIRECTION_URB_SELECT_CONFIGURATION 0x0000u
#define RDP_USB_REDIRECTION_URB_SELECT_INTERFACE 0x0001u
#define RDP_USB_REDIRECTION_URB_PIPE_REQUEST 0x0002u
#define RDP_USB_REDIRECTION_URB_GET_CURRENT_FRAME_NUMBER 0x0007u
#define RDP_USB_REDIRECTION_URB_CONTROL_TRANSFER 0x0008u
#define RDP_USB_REDIRECTION_URB_BULK_OR_INTERRUPT_TRANSFER 0x0009u
#define RDP_USB_REDIRECTION_URB_ISOCH_TRANSFER 0x000au
#define RDP_USB_REDIRECTION_URB_GET_DESCRIPTOR_FROM_DEVICE 0x000bu
#define RDP_USB_REDIRECTION_URB_SET_DESCRIPTOR_TO_DEVICE 0x000cu
#define RDP_USB_REDIRECTION_URB_SET_FEATURE_TO_DEVICE 0x000du
#define RDP_USB_REDIRECTION_URB_SET_FEATURE_TO_INTERFACE 0x000eu
#define RDP_USB_REDIRECTION_URB_SET_FEATURE_TO_ENDPOINT 0x000fu
#define RDP_USB_REDIRECTION_URB_CLEAR_FEATURE_TO_DEVICE 0x0010u
#define RDP_USB_REDIRECTION_URB_CLEAR_FEATURE_TO_INTERFACE 0x0011u
#define RDP_USB_REDIRECTION_URB_CLEAR_FEATURE_TO_ENDPOINT 0x0012u
#define RDP_USB_REDIRECTION_URB_GET_STATUS_FROM_DEVICE 0x0013u
#define RDP_USB_REDIRECTION_URB_GET_STATUS_FROM_INTERFACE 0x0014u
#define RDP_USB_REDIRECTION_URB_GET_STATUS_FROM_ENDPOINT 0x0015u
#define RDP_USB_REDIRECTION_URB_VENDOR_DEVICE 0x0017u
#define RDP_USB_REDIRECTION_URB_VENDOR_INTERFACE 0x0018u
#define RDP_USB_REDIRECTION_URB_VENDOR_ENDPOINT 0x0019u
#define RDP_USB_REDIRECTION_URB_CLASS_DEVICE 0x001au
#define RDP_USB_REDIRECTION_URB_CLASS_INTERFACE 0x001bu
#define RDP_USB_REDIRECTION_URB_CLASS_ENDPOINT 0x001cu
#define RDP_USB_REDIRECTION_URB_SYNC_RESET_PIPE_AND_CLEAR_STALL 0x001eu
#define RDP_USB_REDIRECTION_URB_CLASS_OTHER 0x001fu
#define RDP_USB_REDIRECTION_URB_VENDOR_OTHER 0x0020u
#define RDP_USB_REDIRECTION_URB_GET_STATUS_FROM_OTHER 0x0021u
#define RDP_USB_REDIRECTION_URB_CLEAR_FEATURE_TO_OTHER 0x0022u
#define RDP_USB_REDIRECTION_URB_SET_FEATURE_TO_OTHER 0x0023u
#define RDP_USB_REDIRECTION_URB_GET_DESCRIPTOR_FROM_ENDPOINT 0x0024u
#define RDP_USB_REDIRECTION_URB_SET_DESCRIPTOR_TO_ENDPOINT 0x0025u
#define RDP_USB_REDIRECTION_URB_CONTROL_GET_CONFIGURATION_REQUEST 0x0026u
#define RDP_USB_REDIRECTION_URB_CONTROL_GET_INTERFACE_REQUEST 0x0027u
#define RDP_USB_REDIRECTION_URB_GET_DESCRIPTOR_FROM_INTERFACE 0x0028u
#define RDP_USB_REDIRECTION_URB_SET_DESCRIPTOR_TO_INTERFACE 0x0029u
#define RDP_USB_REDIRECTION_URB_GET_OS_FEATURE_DESCRIPTOR_REQUEST 0x002au
#define RDP_USB_REDIRECTION_URB_SYNC_RESET_PIPE 0x0030u
#define RDP_USB_REDIRECTION_URB_SYNC_CLEAR_STALL 0x0031u
#define RDP_USB_REDIRECTION_URB_CONTROL_TRANSFER_EX 0x0032u

#define RDP_USB_REDIRECTION_TRANSFER_DIRECTION 0x00000001u
...
#define RDP_USB_REDIRECTION_USBD_STATUS_STALL_PID 0xc0000004u
#define RDP_USB_REDIRECTION_USBD_STATUS_DEV_NOT_RESPONDING 0xc0000005u
#define RDP_USB_REDIRECTION_USBD_STATUS_DATA_OVERRUN 0xc0000008u
#define RDP_USB_REDIRECTION_USBD_STATUS_TIMEOUT 0xc0006000u
#define RDP_USB_REDIRECTION_USBD_STATUS_DEVICE_GONE 0xc0007000u
#define RDP_USB_REDIRECTION_USBD_STATUS_NO_MEMORY 0x80000100u
#define RDP_USB_REDIRECTION_USBD_STATUS_INVALID_URB_FUNCTION 0x80000200u
