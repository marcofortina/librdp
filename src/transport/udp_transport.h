 ...
 */
/*
 * Module: UDP and multitransport datagram contract.
 * Invariants: socket/TLS handles and buffered bytes change ownership only on
 * successful setup or teardown calls.
 * Ownership: datagram queues and sequence state remain transport-owned.
...
#define RDP_UDP_ACK_VECTOR_MAX_RUN 64u
#define RDP_UDP_ACK_VECTOR_ENCODED_MAX_SIZE 127u
#define RDP_UDP_MAX_REPORTABLE_GAP \
    (RDP_UDP_ACK_VECTOR_MAX_RUN * RDP_UDP_ACK_VECTOR_ENCODED_MAX_SIZE)
...
#define RDP_UDP2_ACK_VECTOR_MAX_RUN 64u
#define RDP_UDP2_ACK_VECTOR_ENCODED_MAX_SIZE 127u
#define RDP_UDP2_MAX_REPORTABLE_GAP \
    (RDP_UDP2_ACK_VECTOR_MAX_RUN * RDP_UDP2_ACK_VECTOR_ENCODED_MAX_SIZE)
