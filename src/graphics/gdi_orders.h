 ...
 */
/*
 * Module: GDI order parser and serializer declaration contract.
...
#define RDP_GDI_WINDOW_ORDER_TYPE_WINDOW 0x01000000u
#define RDP_GDI_WINDOW_ORDER_TYPE_NOTIFY 0x02000000u
#define RDP_GDI_WINDOW_ORDER_TYPE_DESKTOP 0x04000000u
#define RDP_GDI_WINDOW_ORDER_STATE_NEW 0x10000000u
#define RDP_GDI_WINDOW_ORDER_STATE_DELETED 0x20000000u
#define RDP_GDI_WINDOW_ORDER_ICON 0x40000000u
#define RDP_GDI_WINDOW_ORDER_CACHED_ICON 0x80000000u
...
typedef struct rdp_gdi_gdiplus_order
{
    uint8_t order_type;
    uint8_t cache_type;
    ...
    const uint8_t* data;
    uint32_t data_len;
} rdp_gdi_gdiplus_order;

typedef struct rdp_gdi_window_order
{
    uint16_t order_size;
    uint32_t flags;
    const uint8_t* data;
    uint32_t data_len;
} rdp_gdi_window_order;
