...
static void rdp_server_clipboard_state_reset(librdp_server_peer* peer, int reconnect)
{
    if (!peer)
        return;
...
static int rdp_server_clipboard_state_valid(const librdp_server_clipboard_state* state)
{
