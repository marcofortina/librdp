...
struct librdp_server_peer
{
    ...
    uint8_t multitransport_udp_selected[2];
    ...
    uint32_t device_redirection_client_io_code1;
    uint32_t device_redirection_client_capability_types;
    uint8_t device_redirection_announce_sent;
    uint8_t device_redirection_client_confirmed;
    uint8_t device_redirection_client_named;
    uint8_t device_redirection_capabilities_sent;
    uint8_t device_redirection_capabilities_received;
    uint8_t device_redirection_client_id_sent;
    uint8_t device_redirection_logged_on_sent;
    uint8_t device_redirection_user_logged_on_supported;
